...
-- PostgreSQL Database Schema ΓÇö Sprint 1
...
-- =============================================================================
-- 3. BRANCH ALIASES
--    Maps common HR-entered shorthand/variations ΓåÆ canonical branch_id.
...
COMMENT ON TABLE  branch_aliases           IS 'Approved alias ΓåÆ canonical branch mapping. Fuzzy matching is NOT used.';
...
--    One payment ΓåÆ exactly one verification request (enforced by UNIQUE
